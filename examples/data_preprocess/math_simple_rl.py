...
def _make_test_record(question: str, answer, idx: int, data_source: str,
    ...
    # `n_samples` is consumed by the verl-tool _validate hook to do
    # per-row non-uniform repeat (so MATH-500 stays Avg@1 while AIME/AMC use Avg@32).
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", type=str,
                        default="/mnt/storage/disk1/verl_data/data/math_simple_rl")
