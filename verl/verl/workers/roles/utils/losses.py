...
def ppo_loss(config: ActorConfig, model_output, data: TensorDict, dp_group=None):
    ...
    # vanilla mode with use_clip_less=True returns 5 values, others return 4 values
    use_clip_less = config.get("use_clip_less", False)
    if loss_mode == "vanilla" and use_clip_less:
        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower, accept_rate, D_original, D_sis = policy_loss_fn(
